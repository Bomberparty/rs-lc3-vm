...
This is my attempt to develop *kind of* Low-Level things using Rust. In particular, I wanted to build my own implementation of [LC3](https://en.wikipedia.org/wiki/Little_Computer_3) using [this article about C](https://www.jmeiners.com/lc3-vm/) as a guideline. 
